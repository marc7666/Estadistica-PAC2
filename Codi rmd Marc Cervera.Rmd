...
Com es pot observar, en tots els casos proposats els valors observats en el test d'homoscedasticitat es troben dins del rang de valors crítics, per tant, es conclou que les variàncies són iguals amb un nivell de confiança del 95%.
...
suppressWarnings({
  ...
  aplicacio_test(data$readingScore, data$read30MinsADay),
  ...
  aplicacio_test(more_than_1000_students$readingScore, more_than_1000_students$schoolSize),
...
rownames(results3) <- c("English home", "Read 30 mins", "Urban", "Born US", ">250 mins per week", "<=250 mins per week", ">1000 students", "<=1000 students")
